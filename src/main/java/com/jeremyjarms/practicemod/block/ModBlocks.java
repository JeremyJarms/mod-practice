...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> GEORGE_BLOCK = registerBlock("george_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(1.5f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));

    public static final RegistryObject<Block> RAW_GEORGE_BLOCK = registerBlock("raw_george_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(1.5f).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> GEORGE_ORE = registerBlock("george_ore",
            () -> new DropExperienceBlock(UniformInt.of(2, 4), BlockBehaviour.Properties.of()
                    .strength(1.5f).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> GEORGE_DEEPSLATE_ORE = registerBlock("george_deepslate_ore",
